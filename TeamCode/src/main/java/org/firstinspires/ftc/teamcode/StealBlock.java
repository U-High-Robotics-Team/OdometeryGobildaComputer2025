...
public class DoubleBasketPark extends OpMode {
    ...
    RobotTarget[] targets = {
            ...
            new RobotTarget(-1190, -1240, Math.PI / 2, 2, RobotStates.SUB_1),
            new RobotTarget(-1190, -1240, Math.PI / 2, 1.5, RobotStates.SUB_2),
            ...
            new RobotTarget(-1420, -1240, Math.PI / 2, 2, RobotStates.SUB_1),
            new RobotTarget(-1420, -1240, Math.PI / 2, 1.5, RobotStates.SUB_2),
            new RobotTarget(-1405, -1405, Math.PI / 4, 1.2, RobotStates.HOME),
            new RobotTarget(-1405, -1405, Math.PI / 4, 3.7, RobotStates.BASKET_1),
            new RobotTarget(-1405, -1405, Math.PI / 4, 2.8, RobotStates.BASKET_3),
